...
DECLARE_MEMORY_STAT_EXTERN(TEXT("Preload Memory Allocated"), STAT_WwiseFileHandlerPreloadMemoryAllocated, STATGROUP_WwiseFileHandlerLowLevelIO, WWISEFILEHANDLER_API);
